program RandomWalk
implicit none
integer :: position(2,1000),n,y,g,z ! The 2 used in the declaration can be changed in order to create n-number of walkers, you can also limit the number of time units by altering the right-most index
real::x
