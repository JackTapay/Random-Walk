...
SUBROUTINE PositionCalc(a,n,y,g)
    ...
    y=0
    do n=1,1000
    	if ((a(n) .le. third) .and. ((y .ge. 0) .or. (y .le. 5))) then
        	g(n)=y+1
        	y=g(n)
    	else if (((a(n) .gt. third) .and. (a(n) .le. twothird)) .and. ((y .ge. 1) .or. (y .le. 6))) then
        	g(n)=y-1
        	y=g(n)
    	else if ((a(n) .gt. twothird) .and. ((y .ge. 0) .or. (y .le. 6))) then
        	g(n)=y+0
        	y=g(n)
      else if (y .gt. 6) then
          y=0
